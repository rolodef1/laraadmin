...
class ModuleController extends Controller
{
	...
	public function destroy($id)
	{
		...
		\File::delete(app_path('/Http/Controllers/apiLA/'.$module->name.'Controller.php'));
		...
		if(LAHelper::laravel_ver() == 5.3) {
			...
			$file_api_routes = base_path("/routes/api_routes.php");
		} else {
			$file_admin_routes = base_path("/app/Http/admin_routes.php");
			$file_api_routes = base_path("/app/Http/api_routes.php");
		}
		...
		while(LAHelper::getLineWithString($file_api_routes, "apiLA\\".$module->name."Controller") != -1) {
			$line = LAHelper::getLineWithString($file_api_routes, "apiLA\\".$module->name.'Controller');
	...
	public function generate_crud($module_id)
	{
		...
		CodeGenerator::appendApiRoutes($config);
